...
var author$project$App$Task = F5(
	function (id, description, due, stakes, status) {
		return {description: description, due: due, id: id, stakes: stakes, status: status};
	});
...
var author$project$App$init = {
	tasks: _List_fromArray(
		[
			A5(author$project$App$Task, 0, 'Task 0', 12345678, 5, 'active'),
			A5(author$project$App$Task, 1, 'Task 1', 12345678, 5, 'active')
		])
};
