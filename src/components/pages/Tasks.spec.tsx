...
const renderTasksPage = () => {
  ...
  const getters = render(<MuiPickersUtilsProvider
      utils={DateFnsUtils}><QueryClientProvider client={queryClient}><Tasks
      lastToday={undefined}/></QueryClientProvider></MuiPickersUtilsProvider>),
...
describe("tasks page", () => {
  ...
  it("immediately renders future new task", async () => {
    ...
    const {taskInput, dueInput, addButton, getByText, baseElement} = renderTasksPage();
